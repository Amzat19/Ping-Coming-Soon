...
- Receive an error message when the `form` is submitted if:
	- The `input` field is empty. The message for this error should say *"Please provide a valid email address"*
...
Faster and better handling of HTML CSS and JS webpages
